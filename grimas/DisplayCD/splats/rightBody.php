...
?>
              <table class="table">
                <tr><th class="flip"><span>Title:</span><span>Título:</span></th><td><?= $bib->get_title() ?></td><!--<td><?=$e($item['title'])?></td>--></tr>
				<!--<tr><th>Title Proper</th><td><?= $bib->get_title_proper() ?> <?= $bib->get_title_n() ?> </td></tr>
				<tr><th>245 Title</th><td><?= $bib->get_title() ?></td></tr>-->
