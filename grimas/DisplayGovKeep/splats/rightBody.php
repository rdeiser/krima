...
if ($holding['suppress_from_publishing'] == 'true'){
	...
	$pattern4 = '/(^AUDIO TAPE)|(^BLU-RAY)|(^BLU-RAY.DVD)|(^CD\WROM)|(^COMPACT DISC)|(^COMPUTER DISK)|(^DVD)|(^DVD-ROM)|(^EQUIPMENT)|(^LASERDISC)|(^MAP)|(^MEDIA)|(^MICROCARD)|(^MICROFICHE)|(^MICROFILM)|(^MICROPRINT)|(^PHONODISC)|(^VIDEO TAPE)/';
	$replace4 = '';
...
?>
              <table class="table">
				...
				<tr><th>Hale Location Code</th><td class="statnote"><?= preg_replace($pattern, $replace, $item['statistics_note_3'])?>
				</td></tr>
			  ...
			  <form method="post" action="../DisplayGovKeep/DisplayGovKeep.php">
				<div class="col">
