...
if(preg_match("/[rR]te/", $item['fulfillment_note'])) {
		$style2 = 'style="background-color:#cd3700;"';
}
...
if((preg_match("/[wW]ithdraw/", $item['fulfillment_note'])) {
		$style = 'style="background-color:#cd3700;"';
}
...
if((preg_match("/[vV]oyager/", $item['fulfillment_note'])) {
		$style = 'style="background-color:#cd3700;"';
}
...
if((preg_match("/[tT]ransfer/", $item['fulfillment_note'])) {
		$style = 'style="background-color:#cd3700;"';
}
...
if((preg_match("/[rR]eturn/", $item['fulfillment_note'])) {
		$style = 'style="background-color:#cd3700;"';
}
...
if((preg_match("/[pP]lease/", $item['fulfillment_note'])) {
		$style = 'style="background-color:#cd3700;"';
}
...
if((preg_match("/[lL]ost/", $item['fulfillment_note'])) {
		$style = 'style="background-color:#cd3700;"';
}
...
if((preg_match("/[gG]ive/", $item['fulfillment_note'])) {
		$style = 'style="background-color:#cd3700;"';
}
...
if((preg_match("/[iI][lL][lL]/", $item['fulfillment_note'])) {
		$style = 'style="background-color:#cd3700;"';
}
...
if((preg_match("/[bB]inding/", $item['fulfillment_note'])) {
		$style = 'style="background-color:#cd3700;"';
}
...
if((preg_match("/[rR]oute/", $item['fulfillment_note'])) {
		$style = 'style="background-color:#cd3700;"';
}
