...
?>
              <table class="table">
				...
				<tr><th class="flip"><span>Destination:</span><span>Destino:</span></th><td class="statnote"><?=$item['statistics_note_3']; $pattern = '/^AHD/'; $replace = '/[\s][A-z]+/'; print_r(preg_filter($pattern, Replace, $item['statistics_note_3']))?>
				</td></tr>
				<tr><th></th><td></td></tr>
              </table>
