...
?>
              <table class="table">
                <tr><th>Título:</th><td><?=$e($item['title'])?></td></tr>
				<tr><th>Número de clasificación:</th><td><?=$e($item['call_number'])?></td></tr>
				<tr><th>Descripción:</th><td><?=$e($item['description'])?></td></tr>
				<tr><th>Código de barras:<!--Código de procedencia:--></th><td><?=$e($item['barcode'])?></td></tr>
				<!--<tr><th class="flip"><span>Location:</span><span>Lugar:</span></th><td><?=$e($item['location'])?></td></tr>-->
				<tr <?=$style?>><th>Tipo de Proceso:</th><td><?=$e($item['process_type'])?></td></tr>
				<tr <?=$style2?>><th>Nota de Procesamiento:<!--Nota de servicios al usuario:--></th><td><?=$e($item['fulfillment_note'])?></td></tr>
				...
				<tr><th>Destino:</th><td class="statnote"><?=$e($item['statistics_note_3'])?>
				</td></tr>
				<tr><th></th><td></td></tr>
              </table>
