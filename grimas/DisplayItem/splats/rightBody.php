...
?>
              <table class="table">
				...
				<tr><th class="flip"><span>Destination:</span><span>Destino:</span></th><td class="statnote"><?=$pattern = '/^AHD/'; $replace = 'RED'; if (preg_match("/AHD/i",$item['statistics_note_3'])) { preg_replace($pattern, $replace, $item['statistics_note_3']);}?>
				</td></tr>
				<tr><th></th><td></td></tr>
              </table>
