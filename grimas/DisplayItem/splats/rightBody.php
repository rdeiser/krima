...
?>
              <table class="table">
				...
				<tr><th class="flip"><span>Destination:</span><span>Destino:</span></th><td class="statnote"><?= $pattern = array('/^AHD HALE return/'); $replace = array('HALE return'); print_r(preg_filter($pattern, $replace, $item['statistics_note_3']))?>
				</td></tr>
				<tr><th></th><td></td></tr>
              </table>
