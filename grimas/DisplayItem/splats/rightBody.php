...
?>
              <table class="table">
				...
				<tr><th class="flip"><span>Destination:</span><span>Destino:</span></th><td class="statnote"><?= $pattern = array(); $pattern = ('/^AHD HALE return/'); $replace = array();$replace = 'HALE return'; echo preg_replace($pattern, $replace, $item['statistics_note_3'])?>
				</td></tr>
				<tr><th></th><td></td></tr>
              </table>
