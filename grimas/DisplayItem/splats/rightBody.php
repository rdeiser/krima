...
?>
              <table class="table">
				...
				<tr><th class="flip"><span>Destination:</span><span>Destino:</span></th><td class="statnote"><?=$subject = $item['statistics_note_3']; $pattern = '/^AHD/'; $replace = '/[\s][A-z]+/'; print_r(preg_filter($pattern, $replace, $subject))?>
				</td></tr>
				<tr><th></th><td></td></tr>
              </table>
