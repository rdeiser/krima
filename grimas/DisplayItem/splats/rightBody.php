...
?>
              <table class="table">
				...
				<tr><th class="flip"><span>Destination:</span><span>Destino:</span></th><td class="statnote"><?= $replace = 'HALE return'; print_r(preg_replace('/(AHD HALE return)/', $replace, $item['statistics_note_3']))?>
				</td></tr>
				<tr><th></th><td></td></tr>
              </table>
