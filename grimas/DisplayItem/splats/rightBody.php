...
?>
              <table class="table">
				...
				<tr><th class="flip"><span>Destination:</span><span>Destino:</span></th><td class="statnote"><?= $pattern = '/(AHD HALE return)/'; $replace = 'HALE return'; print_r(preg_replace($replace, $item['statistics_note_3']))?>
				</td></tr>
				<tr><th></th><td></td></tr>
              </table>
