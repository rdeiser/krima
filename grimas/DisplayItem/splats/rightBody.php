...
?>
              <table class="table">
				...
				<tr><th class="flip"><span>Destination:</span><span>Destino:</span></th><td class="statnote"><?= $string = 'April 15, 2003'; $pattern = '//(\w+) (\d+), (\d+)/i'; $replacement = '${1}1,$3'; print_r(preg_replace($pattern, $replace, $string))?>
				</td></tr>
				<tr><th></th><td></td></tr>
              </table>
