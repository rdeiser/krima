...
?>
              <table class="table">
				...
				<tr><th class="flip"><span>Destination:</span><span>Destino:</span></th><td class="statnote"><?=$pattern = '/^AHD/'; if (preg_match("/AHD/i",$item['statistics_note_3'])) { preg_replace($pattern, '/[\s][A-z]+/', $item['statistics_note_3']);}else{$item['statistics_note_3']}?>
				</td></tr>
				<tr><th></th><td></td></tr>
              </table>
